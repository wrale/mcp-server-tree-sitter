...
class ServerConfig(BaseModel):
    ...
    def from_env(cls) -> "ServerConfig":
        ...
        if os.environ.get("MCP_TS_CACHE_ENABLED"):
            config.cache.enabled = os.environ.get("MCP_TS_CACHE_ENABLED").lower() == "true"
        ...
        if os.environ.get("MCP_TS_SECURITY_MAX_FILE_SIZE_MB"):
            config.security.max_file_size_mb = int(os.environ.get("MCP_TS_SECURITY_MAX_FILE_SIZE_MB"))
            
        if os.environ.get("MCP_TS_LANGUAGE_AUTO_INSTALL"):
            config.language.auto_install = os.environ.get("MCP_TS_LANGUAGE_AUTO_INSTALL").lower() == "true"
            
        if os.environ.get("MCP_TS_LANGUAGE_DEFAULT_MAX_DEPTH"):
            config.language.default_max_depth = int(os.environ.get("MCP_TS_LANGUAGE_DEFAULT_MAX_DEPTH"))
