...
def register_project(path: str, name: str = None, description: str = None) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        raise ProjectError(f"Failed to register project: {e}")
...
def get_project(name: str) -> Dict[str, Any]:
    ...
    try:
        ...
        raise ProjectError(f"Failed to get project: {e}")
...
def remove_project(name: str) -> Dict[str, str]:
    ...
    try:
        ...
        raise ProjectError(f"Failed to remove project: {e}")
