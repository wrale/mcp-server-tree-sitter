...
def test_python_function_returns_function_definition() -> None:
...
def test_python_class_returns_class_definition() -> None:
...
def test_javascript_class_returns_class_declaration() -> None:
...
def test_javascript_module_returns_program() -> None:
...
def test_python_enclosure_order() -> None:
...
def test_javascript_enclosure_order() -> None:
...
def test_unknown_language_enclosure_returns_default() -> None:
...
def test_node_type_to_kind_python() -> None:
...
def test_node_type_to_kind_javascript() -> None:
...
def test_node_type_to_kind_unknown_returns_default() -> None:
